...
In Claude Code, the role-based reviewers in `agent-skills/` start with isolated context by design and are usable here — see `agent-skills/` for the roster and per-domain match.
